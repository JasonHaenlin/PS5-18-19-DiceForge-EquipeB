...
public class BoardTest {
    ...
    public void getEligibleCardsTest() {
        ...
        /*
         * //TODO print à changer quand l'initialisation sera plus précise for (Card c :
         * eligibleCardsList){ System.out.println("Coût en pierre de lune : " +
         * c.getMoonStone()); System.out.println("Coût en pierre de soleil : " +
         * c.getSunStone()); System.out.println("Nombre de pts de victoire : " +
         * c.getVictoryPoint());
         * 
         * }
         */
    ...
    public void testForge() {
        for (int i = 0; i < 6; i++) {
            board.forge("Cloud", 0, diceSides.get(i), new DiceSide(1, Resources.GOLD), i);// Can t forge because he
                                                                                          // hasn't got gold
